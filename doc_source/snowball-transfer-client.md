...
**Note**   /usr/local/bin while needed for Symlinks ;does not exist by default. This needs to be created using 
```
sudo mkdir -p /usr/local/bin
```

Credit: [Gordon Davisson via Stackoverflow](https://stackoverflow.com/questions/36730549/cannot-create-a-symlink-inside-of-usr-bin-even-as-sudo)\.
